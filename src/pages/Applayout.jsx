          ...
          </div>
          {
            isLogin ? (
              <div className="grid justify-center mt-4 space-y-6 mx-auto max-w-screen-xl">
                ...
                <form id="add-pin-form" className="space-y-6 mx-auto max-w-screen-xl">
                  ...
                  <div className="rounded-md shadow-sm">
                    ...
                    <input type="color" name="color" id="color" className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-full shadow-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                  </div>
